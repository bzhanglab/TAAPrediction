...
#for (i in 9:9){
  ...
  FilePath = paste(TPMFilePath,'/',Cancer,'.tumor.ProteinCoding.TPM.txt',sep = '')
...
saveRDS(Data, paste0(MaxTPMForCertainProbability_HCC_Pathout,'/MaxTPMForCertainProbability_HCC.rds'))

Data <- readRDS(paste0(MaxTPMForCertainProbability_HCC_Pathout,'/MaxTPMForCertainProbability_HCC.rds'))

pathout = ThresholdSelectionPics_HCC
